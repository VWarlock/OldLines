...
void test16(uchar apogeyVideoHeight) {
  ...
  for(i=2; i<apogeyVideoHeight; i++) {
    ...
    print(40,i,"\x90HELL\x91O WO\x94RLD \x95!!! \x98THIS\x99 IS \x9CTEST\x9D:):)");
    i++;
    if(i==apogeyVideoHeight) break;
    print(0,i,"\x82HELL\x83O WO\x86RLD \x87!!! \x8ATHIS\x8B IS \x8ETEST\x8F:):)");
    print(40,i,"\x92HELL\x93O WO\x96RLD \x97!!! \x9ATHIS\x9B IS \x9ETEST\x9F:):)");
  }
  getch();
}
...
void gtest16(uchar apogeyVideoHeight) {
  ...
  for(i=3; i<apogeyVideoHeight; i++) {
    ...
    print(40,i,"\x90\x3F\x7F\x7B\x44\x91\x3F\x7F\x7B\x44\x94\x3F\x7F\x7B\x44\x95\x3F\x7F\x7B\x44\x98\x3F\x7F\x7B\x44\x99\x3F\x7F\x7B\x44\x9C\x3F\x7F\x7B\x44\x9D\x3F\x7F\x7B\x44");
  }
  getch();
}
...
void main() {   
  ...
  while(1) {
    ...
    print(32,0,"\x8080\x8181\x8484\x8585\x8888\x8989\x8C8C\x8D8D\x8282\x8383\x8686\x8787\x8A8A\x8B8B\x8E8E\x8F8F");
    print(32,1,"\x9080\x9181\x9484\x9585\x9888\x9989\x9C8C\x9D8D\x9282\x9383\x9686\x9787\x9A8A\x9B8B\x9E8E\x9F8F");
    test16(31);
    ...
    apogeyScreen3C();
    print(32,0,"\x80\x7B\x81\x7B\x84\x7B\x85\x7B\x88\x7B\x89\x7B\x8C\x7B\x8D\x7B\x82\x7B\x83\x7B\x86\x7B\x87\x7B\x8A\x7B\x8B\x7B\x8E\x7B\x80");
    print(32,1,"\x90\x7B\x91\x7B\x94\x7B\x95\x7B\x98\x7B\x99\x7B\x9C\x7B\x9D\x7B\x92\x7B\x93\x7B\x96\x7B\x97\x7B\x9A\x7B\x9B\x7B\x9E\x7B\x80");
    print(32,2,"\x80\x7B\x81\x7B\x84\x7B\x85\x7B\x88\x7B\x89\x7B\x8C\x7B\x8D\x7B\x82\x7B\x83\x7B\x86\x7B\x87\x7B\x8A\x7B\x8B\x7B\x8E\x7B\x80");
